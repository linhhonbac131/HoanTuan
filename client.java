	...
	public void actionPerformed(ActionEvent e) {
			...
			if(checkLogin(nick1.getText())){
				...
				dataStream = new ThreadClien(this, this.dis);
                        ...
                        else{JOptionPane.showMessageDialog(this,"Đã tồn tại níck này trong room, bạn vui lòng nhập lại.","Message Dialog",JOptionPane.WARNING_MESSAGE);}
